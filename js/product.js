$(function() {
    ...
    var product_shuinigaiban = [{
        ...
        type: 3,
        name: '镀锌格栅',
        background: 'dist/image/product/58/1.jpg',
        link: '/product/58.html',
        detail: [{
            spec: '250x1000',
            thick: '30/40/50'
        }, {
        ...
        type: 3,
        name: '镀锌格栅',
        background: 'dist/image/product/59/1.jpg',
        link: '/product/59.html',
        detail: [{
            spec: '250x1000',
            thick: '30/40/50'
        }, {
        ...
        type: 3,
        name: '防滑雨水盖板',
        background: 'dist/image/product/56/1.jpg',
        link: '/product/56.html',
        detail: [{
            spec: '200x1000',
            thick: '30/40/50'
        },{
    ...
    var product_shajinggai = [{
        ...
        type: 3,
        name: '平入式雨水井',
        background: 'dist/image/product/37/2.jpg',
        link: '/product/37.html',
        detail: [{
            spec: '300x500',
            thick: ''
        }, {
        ...
        type: 3,
        name: '雨水井',
        background: 'dist/image/product/57/1.jpg',
        link: '/product/57.html',
        detail: [{
            spec: '600',
            thick: ''
        }, {
    ...
    $.each(product_shajinggai, function(key, data) {
        ...
        var leftTr = 4 - data.detail.length;
        if (leftTr > 0) {
            details += '<tr>' + '<td rowspan="' + leftTr + '" colspan="2"></td></tr>';
        }
        productTemplate.find('.product-spec tbody').html(details);
        productTemplate.find('a').attr('href', data.link);
    ...
    var product_fangzhuanggelidun = [{
        ...
        type: 4,
        name: '防撞隔离墩',
        background: 'dist/image/product/17/1.jpg',
    ...
    var product_luceshi = [{
        ...
        type: 5,
        name: '路侧石',
        background: 'dist/image/product/18/3.jpg',
        link: '/product/18.html',
        detail: [{
            spec: '1000x600',
            thick: '200'
        ...
        type: 5,
        name: '路侧石',
        background: 'dist/image/product/18/2.jpg',
        link: '/product/18.html',
        detail: [{
            spec: '1000x600',
            thick: '200'
    ...
    var product_gereban = [{
        ...
        type: 7,
        name: '挤塑板隔热砖',
        background: 'dist/image/product/25/4.jpg',
        link: '/product/25.html',
        detail: [{
            spec: '300x300',
            thick: '35'
        ...
        type: 7,
        name: '挤塑板隔热砖',
        background: 'dist/image/product/25/5.jpg',
        link: '/product/25.html',
        detail: [{
            spec: '300x300',
            thick: '35'
        ...
        type: 7,
        name: '泡沫隔热砖',
        background: 'dist/image/product/25/1.jpg',
        link: '/product/25.html',
        detail: [{
            spec: '300x300',
            thick: '35'
        ...
        type: 7,
        name: '泡沫隔热砖',
        background: 'dist/image/product/25/2.jpg',
        link: '/product/25.html',
        detail: [{
            spec: '300x300',
            thick: '35'
        ...
        type: 7,
        name: '泡沫隔热砖',
        background: 'dist/image/product/25/3.jpg',
        link: '/product/25.html',
        detail: [{
            spec: '300x300',
            thick: '35'
    ...
    var product_huagangyanshicai = [{
        ...
        type: 10,
        name: '大理石石材',
        background: 'dist/image/product/64/1.jpg',
        link: '/product/64.html',
        detail: [{
            spec: '300x450',
            thick: ''
        }]
        ...
        type: 10,
        name: '大理石路侧石',
        background: 'dist/image/product/64/2.jpg',
        link: '/product/66.html',
        detail: [{
            spec: '500x600',
            thick: '200'
        },{
        ...
        type: 10,
        name: '花岗岩导盲砖',
        background: 'dist/image/product/64/3.jpg',
        link: '/product/67.html',
        detail: [{
            spec: '300x300',
            thick: '50'
        },{
    ...
    var product_hunningtupaishuiguan = [{
        ...
        type: 9,
        name: '混凝土顶管',
        background: 'dist/image/product/28/1.jpg',
        link: '/product/28.html',
        detail: [{
            spec: '800x2500',
            thick: '80'
        ...
        type: 9,
        name: '混凝土排污管',
        background: 'dist/image/product/28/2.jpg',
        link: '/product/28.html',
        detail: [{
            spec: '300x2000',
            thick: '50'
    ...
    var product_shuinizhipin = [{
        ...
        type: 10,
        name: '电力拼版',
        background: 'dist/image/product/40/1.jpg',
        link: '/product/40.html',
        detail: [{
            spec: '820x415',
            thick: '80'
        ...
        type: 10,
        name: '水槽',
        background: 'dist/image/product/41/1.jpg',
        link: '/product/41.html',
        detail: [{
            spec: '1000x600',
            thick: '50'
        ...
        type: 10,
        name: '水槽',
        background: 'dist/image/product/41/2.jpg',
        link: '/product/41.html',
        detail: [{
            spec: '1000x600',
            thick: '50'
